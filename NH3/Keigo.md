...
<details>
    <summary><h3 style="display:inline">How to: -ます-form</h3></summary>
    <p>
        <h4>-iる/-eる Verbs</h4>
        Verbs ending in -iru and -eru (Ichidan Verbs): 
        <ol style="border-left: 2px solid #c45335">
            <li>build verb stem (remove final る)</li>
            <li>add -ます</li>
        </ol>
        <table>
            <thead>
            ...
            <tbody>
                 ...
                 <tr>
                    <td>あげる</td> 
                    <td>to give, to gift</td>
                    <td><div id="teineigo-masu-form-exercise-ageru-stem" onclick="document.getElementById('teineigo-masu-form-exercise-ageru-stem').innerHTML = document.getElementById('teineigo-masu-form-exercise-ageru-stem').innerHTML != 'あげ'? 'あげ' : 'Click to Reveal'">Click to Reveal</div> </td>
                    <td><div id="teineigo-masu-form-exercise-ageru-masu" onclick="document.getElementById('teineigo-masu-form-exercise-ageru-masu').innerHTML = document.getElementById('teineigo-masu-form-exercise-ageru-masu').innerHTML != 'あげます'? 'あげます' : 'Click to Reveal'">Click to Reveal</div> </td>
                </tr>
            </tbody>
        </table>
    </p>
    <p>
        <h4>Other Verbs</h4>
        <ol style="border-left: 2px solid #c45335">
            <li>change Vowel of last Kana (る &rarr; り, う &rarr; い, く &rarr; き)</li>
            <li>add -ます</li>
        </ol>
        <table>
         <thead>
            ...
            <tbody>
                <tr>
                 ...
                 <tr>
                    <td>頑張る (がんばる)</td> 
                    <td>to do one's best</td>
                    <td><div id="teineigo-masu-form-exercise-gambaru-stem" onclick="document.getElementById('teineigo-masu-form-exercise-gambaru-stem').innerHTML = document.getElementById('teineigo-masu-form-exercise-gambaru-stem').innerHTML != '頑張り (がんばり)'? '頑張り (がんばり)' : 'Click to Reveal'">Click to Reveal</div> </td>
                    <td><div id="teineigo-masu-form-exercise-gambaru-masu" onclick="document.getElementById('teineigo-masu-form-exercise-gambaru-masu').innerHTML = document.getElementById('teineigo-masu-form-exercise-gambaru-masu').innerHTML != '頑張ります (がんばります)'? '頑張ります (がんばります)' : 'Click to Reveal'">Click to Reveal</div> </td>
                </tr>
            </tbody>
        </table>
    </p>
...
> Do not use this form to refer to yourself! 
...
| to eat          | <b style="color: #5e606c">たべる</b><br><b style="color: #203856">食べる</b>     | <b style="color: #5e606c">たべます</b><br><b style="color: #203856">食べます</b>         | <b style="color: #5e606c">めしあがります</b> <br>  <b style="color: #203856">召し上がります</b>     | <b style="color: #203856">いただきます </b>                                                                                                                                        |
...
| to know         | <b style="color: #5e606c">しってる</b><br> <b style="color: #203856">知ってる</b>  | <b style="color: #5e606c">しっています</b>   <br> <b style="color: #203856">知っています</b> | <b style="color: #5e606c">ごぞんじです</b>   <br><b style="color: #203856">ご存知です</b>        | <b style="color: #203856">しっております         </b>                                                                                                                               |
